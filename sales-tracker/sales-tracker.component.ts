...
@Component({
  ...
  styleUrls: ['./sales-tracker.component.css']
})
export class SalesTrackerComponent implements OnInit {

  constructor(private spinner: NgxSpinnerService, public salesTrackerService: SalesTrackerService) { }
  ...
  loadMultiColumnChart() {
    ...
    this.multiColumnTitle = '2021 Sales Column';
    this.multiColumnSubTitle = '(thousands)'
  ...
  loadTrackballChart() {
    this.trackballData = [
      { "X": "2020-12-31T00:00:00", "Y": 113, "Y1": 84, "Y2": 61, "Y3": 61, "Y4": 85, "Y5": 77, "Y6": 94 },
      { "X": "2021-01-31T00:00:00", "Y": 54, "Y1": 56, "Y2": 60, "Y3": 64, "Y4": 56, "Y5": 87, "Y6": 41 },
      { "X": "2021-02-28T00:00:00", "Y": 67, "Y1": 44, "Y2": 106, "Y3": 110, "Y4": 88, "Y5": 66, "Y6": 63 },
      { "X": "2021-03-31T00:00:00", "Y": 55, "Y1": 101, "Y2": 60, "Y3": 44, "Y4": 98, "Y5": 118, "Y6": 119 },
      { "X": "2021-04-30T00:00:00", "Y": 84, "Y1": 45, "Y2": 112, "Y3": 95, "Y4": 36, "Y5": 56, "Y6": 72 },
      { "X": "2021-05-31T00:00:00", "Y": 67, "Y1": 64, "Y2": 52, "Y3": 48, "Y4": 110, "Y5": 88, "Y6": 88 },
      { "X": "2021-06-30T00:00:00", "Y": 67, "Y1": 101, "Y2": 98, "Y3": 99, "Y4": 54, "Y5": 44, "Y6": 55 }
    ]
    this.trackballXAxis = {
      title: 'Sales Rep',
      minimum: new Date(2020, 12, 15), maximum: new Date(2021, 6, 30),
      intervalType: 'Months',
      valueType: 'DateTime',
    };
